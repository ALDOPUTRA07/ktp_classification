...
unit-tests-cov-report-html:
	@pytest --cov=ktp_classification --cov-report term-missing --cov-report=html

unit-tests-cov-fail:
	@pytest --cov=ktp_classification --cov-report term-missing --cov-report=html --cov-fail-under=75
...
lint-mypy:
	@mypy ./ktp_classification

lint-mypy-report:
	@mypy ./ktp_classification --html-report ./mypy_html
